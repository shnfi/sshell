   ...
   )
{
   ...
   else if (strcmp(called_command_finder(trim_extra_spaces(command_data)), "psetting") == 0) psetting_c(command_data, clock_or_date, round_or_square, prompt_type, additional_line);
