...
{
   if (strcmp(called_command_finder(trim_extra_spaces(command_data)), "help") == 0) help_c(command_data, USERNAME, additional_line, using_color_index);
   ...
   else if (strcmp(called_command_finder(trim_extra_spaces(command_data)), "cd") == 0) cd_c(command_data, additional_line, using_color_index);
   else if (strcmp(called_command_finder(trim_extra_spaces(command_data)), "ls") == 0) ls_c(command_data, getcwd(NULL, 100), additional_line, using_color_index);
   ...
   else if (strcmp(called_command_finder(trim_extra_spaces(command_data)), "touch") == 0) touch_c(getcwd(NULL, 100), command_data, additional_line, using_color_index);
   else if (strcmp(called_command_finder(trim_extra_spaces(command_data)), "mkdir") == 0) mkdir_c(getcwd(NULL, 100), command_data, additional_line, using_color_index);
   else if (strcmp(called_command_finder(trim_extra_spaces(command_data)), "rm") == 0) rm_c(getcwd(NULL, 100), command_data, additional_line, using_color_index);
   else if (strcmp(called_command_finder(trim_extra_spaces(command_data)), "echo") == 0) echo_c(command_data, additional_line, using_color_index);
   else if (strcmp(called_command_finder(trim_extra_spaces(command_data)), "search") == 0) search_c(command_data, line, command_len);
   else if (strcmp(called_command_finder(trim_extra_spaces(command_data)), "sizeof") == 0) sizeof_c(command_data, additional_line, using_color_index);
   else
   {
      /*
